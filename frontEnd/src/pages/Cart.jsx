          ...
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className='py-4 boder-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                  ...
                  <input type="number" onChange={(e)=>e.target.value===''? null: updateQuantity(item._id,item.size,Number(e.target.value))}  min={1} defaultValue={item.quantity} className='border mx-w-10 sm:max-w-20 px-1 sm:px-2 py-1' />
