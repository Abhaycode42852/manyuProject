    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <div className='text-xl sm:text-2xl my-3'>
            <Title text1={'DILIVERY'} text2={'INFORMARION'} />
          </div>
          <div className='flex gap-3'>
            <input required type="text" onChange={handleChange} name='firstName' value={formData.firstName} placeholder='First name' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
            <input required type="text" onChange={handleChange} name='lastName' value={formData.lastName} placeholder='Last name' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
          </div>
            <input required onChange={handleChange} name='email' value={formData.email} type="email" placeholder='Email address' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
          ...
          <div className='flex gap-3'>
            <input required onChange={handleChange} name='pincode' value={formData.pincode} type="number" placeholder='Pin-Code' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
          ...
          <input required onChange={handleChange} name='phone' value={formData.phone} type="number" placeholder='Phone' className='border border-gray-300 rounded py-1.5 px-3.5 w-full' />
      </div>
      {/* ------Right Side------ */}
      <div className='mt-8'>
